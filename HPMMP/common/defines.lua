...
diplomacy = {
    ...
    CANCELASKMILACCESS_DIPLOMATIC_COST = 3,
    ...
    CANCELGIVEMILACCESS_DIPLOMATIC_COST = 3,
    ...
    SPHERE_NEIGHBOUR_BONUS_INFLUENCE_PERCENT = 0.35, -- Bonus to countries in your sphere neighbouring when influencing
